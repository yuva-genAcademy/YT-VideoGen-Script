...
export const TITLE_SCENE_DURATION = 900;
    ...
    <AbsoluteFill style={{ background: GA.bg, opacity: sceneOpacity }}>
      ...
      >
        ...
        {[[0, 0], [width, 0], [0, height], [width, height]].map(([cx, cy], i) => (
          <circle key={`dot${i}`} cx={cx} cy={cy} r={3} fill={GA.yellow} opacity={0.3} />
        ))}
      </svg>
      ...
      <div
        style={{
          ...
          width: 600,
          height: 300,
          background: `radial-gradient(ellipse, ${GA.yellow}18 0%, transparent 70%)`,
          pointerEvents: 'none',
        }}
      />
      ...
      >
        ...
        >
          Agent
          <span style={{ color: GA.yellow }}> Architecture</span>
        </div>
